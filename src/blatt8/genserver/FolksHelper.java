...
abstract public class FolksHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = blatt8.genserver.PositionedAvatarHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (blatt8.genserver.FolksHelper.id (), "Folks", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    blatt8.genserver.PositionedAvatar value[] = null;
    int _len0 = istream.read_long ();
    value = new blatt8.genserver.PositionedAvatar[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = blatt8.genserver.PositionedAvatarHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, blatt8.genserver.PositionedAvatar[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      blatt8.genserver.PositionedAvatarHelper.write (ostream, value[_i0]);
  }
