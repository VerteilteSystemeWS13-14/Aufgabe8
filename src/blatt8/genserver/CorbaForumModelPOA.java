...
public abstract class CorbaForumModelPOA extends org.omg.PortableServer.Servant
 implements blatt8.genserver.CorbaForumModelOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    switch (__method.intValue ())
    {
       case 0:  // blatt8/gen/CorbaForumModel/registerView
       {
         try {
           ...
           blatt8.genserver.CorbaForumView view = blatt8.genserver.CorbaForumViewHelper.read (in);
           this.registerView (name, view);
           out = $rh.createReply();
         } catch (blatt8.genserver.AlreadyBoundException $ex) {
           out = $rh.createExceptionReply ();
           blatt8.genserver.AlreadyBoundExceptionHelper.write (out, $ex);
         }
         break;
       }
       ...
       case 1:  // blatt8/gen/CorbaForumModel/deregisterView
       {
         try {
           ...
           out = $rh.createReply();
         } catch (blatt8.genserver.NotBoundException $ex) {
           out = $rh.createExceptionReply ();
           blatt8.genserver.NotBoundExceptionHelper.write (out, $ex);
         }
         break;
       }
